...
namespace Bau.Controls.TaskbarNotifier
{
	/// <summary>
	...
	public class TaskbarNotifier : System.Windows.Forms.Form
	{
		// Protected Members
			...
			protected string titleText, contentText;
		...
		{	// Window Style
			...
			// Inicializa las imágenes
				BackgroundBitmap = Properties.Resources.SkinNotify;
				CloseBitmap = Properties.Resources.cancel;
			// Inicializa los rectángulos
				TitleRectangle = new Rectangle(0, 5, BackgroundBitmap.Width, 20);
				ContentRectangle = new Rectangle(0, 0, BackgroundBitmap.Width, BackgroundBitmap.Height);
		...
		{	SetBackgroundBitmap(new Bitmap(strFilename), transparencyColor);
		}
		...
		{	SetCloseBitmap(new Bitmap(strFilename), transparencyColor, position);
		}
