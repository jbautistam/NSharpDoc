...
namespace Bau.Controls.List
{
	...
	{ // Delegados
			public delegate void UpdateRecordHandler(object objSender, string key);
			public delegate void DeleteRecordHandler(object objSender, string key);
			public delegate void MoveRecordHandler(object objSender, string key, bool blnUp);
		// Eventos
		...
		{ AddColumn(intWidth, text, Bau.Controls.List.ListViewExtended.ListViewColumnType.Text);
		}

		/// <summary>
		///		Añade una columna
		/// </summary>
		public void AddColumn(int intWidth, string text, Bau.Controls.List.ListViewExtended.ListViewColumnType intColumnType)
		{ lswItems.AddColumn(intWidth, text, intColumnType);
		}
		
		/// <summary>
		///		Añade un registro
		/// </summary>
		public ListViewItem AddRecord(string key, string text)
		{ return lswItems.AddItem(key, text);
		}		
		...
		private void lswItems_ItemDoubleClick(object objSender, string key)
		{ if (OnUpdateRecord != null && WithUpdate && !string.IsNullOrEmpty(key))
				OnUpdateRecord(this, key);
		}
